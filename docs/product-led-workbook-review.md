...
| Today controls do not explain what changing minutes/focus/energy affects | P2 | The user has to infer whether changing capacity modifies Tasks, Today, or source tabs | 0 + 2 + 5 | Fixed: Today now has a compact control-area helper line and notes on the planning controls |
